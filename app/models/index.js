...
// models
db.User          = require("./user.model")(connection, types)
// db.usermeta      = require("./usermeta.model.js")(sequelize, Sequelize)
...
// db.productmeta   = require("./productmeta.model.js")(sequelize, Sequelize)
