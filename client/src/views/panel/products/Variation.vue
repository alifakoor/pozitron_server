<template>
    <div class="_new-product variation">
        <div
            ...
            <b-row>
                <b-col>
                    <b-form-group
                        ...
                        class="mb-1"
                    >
                        <b-form-input id="input-sku" v-model="form.sku" disabled></b-form-input>
                    </b-form-group>
                </b-col>
            </b-row>
            <b-row>
                <b-col>
                    <b-form-group
                        ...
                        class="mb-1"
                    >
                        <b-form-input id="input-name" v-model="form.name" disabled></b-form-input>
                    </b-form-group>
                </b-col>
            </b-row>
            <b-row>
...
export default {
    ...
    computed: {
        ...
        ...mapState({
            form: state => state.product.newProduct.variation,
